...
const Experience = () => {
    ...
    // Helper to render descriptions with [text](link) and newlines
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="mt-4 text-xl" style={{ color: 'var(--text-muted)' }}>
                        Mon parcours dans le monde du travail et mes projets actuels.
                    </p>
                </motion.div>
                ...
                >
                    {experience.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="p-8 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/[0.08] transition-colors" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', borderColor: 'var(--border)' }}>
                                ...
                                <div className="mb-6 leading-relaxed" style={{ color: 'var(--text-muted)' }}>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {exp.skills.map((skill) => (
                                        <span 
                                            key={skill} 
                                            className="text-xs px-3 py-1 rounded-lg bg-slate-800/80 border border-white/5 text-slate-300" 
